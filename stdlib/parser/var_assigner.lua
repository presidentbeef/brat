...
_temp3 = string:new("simple_index_get")

local _temp242 = function (_self, _temp238)
...
local _temp240 = nil
    ...
    elseif _temp238 then
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        _temp240 =  _self:no_undermethod(string:new("node"))
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        _temp240 =  no_undermethod(_self, string:new("node"))
      else
        _error(exception:name_error("node"))
      end
    end
      ...
      if _t == "table" then
                      if _type(_temp239.proc_undercall) == "function" or (_type(_temp239.proc_undercall) == "table" and _rawget(_temp239.proc_undercall, "__call_thing")) then
        return _temp239:proc_undercall(_temp240)
      elseif _temp239.proc_undercall ~= nil then
        return _temp239.proc_undercall

        elseif _temp239.no_undermethod ~= nil then
          return  _temp239:no_undermethod(string:new("proc_call") , _temp240)
        else
          _error(exception:method_error(_temp239, "proc_call"))
        end

      elseif _t == "number" then
              local _n = number:new(_temp239)
      if _n.proc_undercall ~= nil then
        return _n:proc_undercall(_temp240)
      elseif _n.no_undermethod ~= nil then
        return  _n:no_undermethod(string:new("proc_call") , _temp240)
      else
        _error(exception:method_error(_temp239, "proc_call"))
      end
      ...
      if _f.proc_undercall ~= nil then
        return _f:proc_undercall(_temp240)
      elseif _f.no_undermethod ~= nil then
        return  _f:no_undermethod(string:new("proc_call") , _temp240)
      else
        _error(exception:method_error(_temp239, "proc_call"))
      end

      elseif _temp239 == nil then
        _error(exception:null_error("_temp239", "invoke proc_call on it"))
      else
      ...
      if _t == "table" then
        ...
        _dummy_ = _temp237:walk(_temp3,_temp242)
      elseif _temp237.walk ~= nil then
        _dummy_ = _temp237.walk

        elseif _temp237.no_undermethod ~= nil then
          _dummy_ =  _temp237:no_undermethod(string:new("walk") , _temp3,_temp242)
        else
      ...
      if _n.walk ~= nil then
        _dummy_ = _n:walk(_temp3,_temp242)
      elseif _n.no_undermethod ~= nil then
        _dummy_ =  _n:no_undermethod(string:new("walk") , _temp3,_temp242)
      else
        _error(exception:method_error(_temp237, "walk"))
      end
      ...
      if _f.walk ~= nil then
        _dummy_ = _f:walk(_temp3,_temp242)
      elseif _f.no_undermethod ~= nil then
        _dummy_ =  _f:no_undermethod(string:new("walk") , _temp3,_temp242)
      else
        _error(exception:method_error(_temp237, "walk"))
      end
        ...
        if _t == "table" then
          if _rawget(_temp5, "__call_thing") == nil then
            _temp242 = _temp5
                  ...
                  if _temp5 == nil then
              if _type(_self._temp5) == "function" or (_type(_self._temp5) == "table" and _rawget(_self._temp5, "__call_thing")) then
        _temp242 =  _self:_temp5()
      elseif _self._temp5 ~= nil then
        _temp242 =  _self._temp5

        elseif _self.no_undermethod ~= nil then
          _temp242 =  _self:no_undermethod(string:new("_temp5"))
        else
          _error(exception:null_error("a", "invoke method"))
        end
      else 
        _temp242 =  _temp5(_self)
      end
...
_temp3 = string:new("simple_index_set")

local _temp247 = function (_self, _temp243)
...
local _temp245 = nil
    ...
    elseif _temp243 then
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        _temp245 =  _self:no_undermethod(string:new("node"))
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        _temp245 =  no_undermethod(_self, string:new("node"))
      else
        _error(exception:name_error("node"))
      end
    end
      ...
      if _t == "table" then
                      if _type(_temp244.proc_undercall) == "function" or (_type(_temp244.proc_undercall) == "table" and _rawget(_temp244.proc_undercall, "__call_thing")) then
        return _temp244:proc_undercall(_temp245)
      elseif _temp244.proc_undercall ~= nil then
        return _temp244.proc_undercall

        elseif _temp244.no_undermethod ~= nil then
          return  _temp244:no_undermethod(string:new("proc_call") , _temp245)
        else
          _error(exception:method_error(_temp244, "proc_call"))
        end

      elseif _t == "number" then
              local _n = number:new(_temp244)
      if _n.proc_undercall ~= nil then
        return _n:proc_undercall(_temp245)
      elseif _n.no_undermethod ~= nil then
        return  _n:no_undermethod(string:new("proc_call") , _temp245)
      else
        _error(exception:method_error(_temp244, "proc_call"))
      end
      ...
      if _f.proc_undercall ~= nil then
        return _f:proc_undercall(_temp245)
      elseif _f.no_undermethod ~= nil then
        return  _f:no_undermethod(string:new("proc_call") , _temp245)
      else
        _error(exception:method_error(_temp244, "proc_call"))
      end

      elseif _temp244 == nil then
        _error(exception:null_error("_temp244", "invoke proc_call on it"))
      else
      ...
      if _t == "table" then
                      if _type(_temp242.walk) == "function" or (_type(_temp242.walk) == "table" and _rawget(_temp242.walk, "__call_thing")) then
        _dummy_ = _temp242:walk(_temp3,_temp247)
      elseif _temp242.walk ~= nil then
        _dummy_ = _temp242.walk

        elseif _temp242.no_undermethod ~= nil then
          _dummy_ =  _temp242:no_undermethod(string:new("walk") , _temp3,_temp247)
        else
          _error(exception:method_error(_temp242, "walk"))
        end

      elseif _t == "number" then
              local _n = number:new(_temp242)
      if _n.walk ~= nil then
        _dummy_ = _n:walk(_temp3,_temp247)
      elseif _n.no_undermethod ~= nil then
        _dummy_ =  _n:no_undermethod(string:new("walk") , _temp3,_temp247)
      else
        _error(exception:method_error(_temp242, "walk"))
      end
      ...
      if _f.walk ~= nil then
        _dummy_ = _f:walk(_temp3,_temp247)
      elseif _f.no_undermethod ~= nil then
        _dummy_ =  _f:no_undermethod(string:new("walk") , _temp3,_temp247)
      else
        _error(exception:method_error(_temp242, "walk"))
      end

      elseif _temp242 == nil then
        _error(exception:null_error("_temp242", "invoke walk on it"))
      else
        ...
        if _t == "table" then
          if _rawget(_temp5, "__call_thing") == nil then
            _temp247 = _temp5
                  ...
                  if _temp5 == nil then
              if _type(_self._temp5) == "function" or (_type(_self._temp5) == "table" and _rawget(_self._temp5, "__call_thing")) then
        _temp247 =  _self:_temp5()
      elseif _self._temp5 ~= nil then
        _temp247 =  _self._temp5

        elseif _self.no_undermethod ~= nil then
          _temp247 =  _self:no_undermethod(string:new("_temp5"))
        else
          _error(exception:null_error("a", "invoke method"))
        end
      else 
        _temp247 =  _temp5(_self)
      end
...
local _temp254 = function (_self, _temp248)
...
do
      ...
      if _t == "table" then
                      if _type(_temp250.env) == "function" or (_type(_temp250.env) == "table" and _rawget(_temp250.env, "__call_thing")) then
        _temp250 = _temp250:env()
      elseif _temp250.env ~= nil then
        _temp250 = _temp250.env

        elseif _temp250.no_undermethod ~= nil then
          _temp250 =  _temp250:no_undermethod(string:new("env"))
        else
      ...
      if _n.env ~= nil then
        _temp250 = _n:env()
      elseif _n.no_undermethod ~= nil then
        _temp250 =  _n:no_undermethod(string:new("env"))
      else
        _error(exception:method_error(_temp250, "env"))
      end
      ...
      if _f.env ~= nil then
        _temp250 = _f:env()
      elseif _f.no_undermethod ~= nil then
        _temp250 =  _f:no_undermethod(string:new("env"))
      else
        _error(exception:method_error(_temp250, "env"))
      end

      elseif _temp250 == nil then
        _error(exception:null_error("_temp250", "invoke env on it"))
      else
...
local _temp251 = nil
    if _type(_true) == "function" or (_type(_true) == "table" and _rawget(_true, "__call_thing")) then
      _temp251 =  _true(_self)

    elseif _true then
      _temp251 =  _true
    else
            if _type(_self._true) == "function" or (_type(_self._true) == "table" and _rawget(_self._true, "__call_thing")) then
        _temp251 =  _self:_true()
      elseif _self._true ~= nil then
        _temp251 =  _self._true
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        _temp251 =  _self:no_undermethod(string:new("_true"))
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        _temp251 =  no_undermethod(_self, string:new("_true"))
      else
        _error(exception:name_error("_true"))
      end
    end
...
local _temp252 = nil
        ...
        _temp252 =  _self:_temp248()
      elseif _self._temp248 ~= nil then
        _temp252 =  _self._temp248

        elseif _self.no_undermethod ~= nil then
          _temp252 =  _self:no_undermethod(string:new("_temp248"))
        else
          _error(exception:null_error("node", "invoke method"))
        end
      else 
        _temp252 =  _temp248(_self)
      end
      ...
      if _t == "table" then
                      if _type(_temp252.id) == "function" or (_type(_temp252.id) == "table" and _rawget(_temp252.id, "__call_thing")) then
        _temp252 = _temp252:id()
      elseif _temp252.id ~= nil then
        _temp252 = _temp252.id

        elseif _temp252.no_undermethod ~= nil then
          _temp252 =  _temp252:no_undermethod(string:new("id"))
        else
          _error(exception:method_error(_temp252, "id"))
        end
      ...
      if _n.id ~= nil then
        _temp252 = _n:id()
      elseif _n.no_undermethod ~= nil then
        _temp252 =  _n:no_undermethod(string:new("id"))
      else
        _error(exception:method_error(_temp252, "id"))
      end
      ...
      if _f.id ~= nil then
        _temp252 = _f:id()
      elseif _f.no_undermethod ~= nil then
        _temp252 =  _f:no_undermethod(string:new("id"))
      else
        _error(exception:method_error(_temp252, "id"))
      end

      elseif _temp252 == nil then
        _error(exception:null_error("_temp252", "invoke id on it"))
      else
        _error("Tried to invoke method on something strange: " .. _tostring(_temp252))
      end


_temp250 = _temp250:set(_temp252, _temp251)
end
...
return _temp250
      ...
      if _t == "table" then
                      if _type(_temp247.walk) == "function" or (_type(_temp247.walk) == "table" and _rawget(_temp247.walk, "__call_thing")) then
        _dummy_ = _temp247:walk(_temp3,_temp254)
      elseif _temp247.walk ~= nil then
        _dummy_ = _temp247.walk

        elseif _temp247.no_undermethod ~= nil then
          _dummy_ =  _temp247:no_undermethod(string:new("walk") , _temp3,_temp254)
        else
          _error(exception:method_error(_temp247, "walk"))
        end

      elseif _t == "number" then
              local _n = number:new(_temp247)
      if _n.walk ~= nil then
        _dummy_ = _n:walk(_temp3,_temp254)
      elseif _n.no_undermethod ~= nil then
        _dummy_ =  _n:no_undermethod(string:new("walk") , _temp3,_temp254)
      else
        _error(exception:method_error(_temp247, "walk"))
      end
      ...
      if _f.walk ~= nil then
        _dummy_ = _f:walk(_temp3,_temp254)
      elseif _f.no_undermethod ~= nil then
        _dummy_ =  _f:no_undermethod(string:new("walk") , _temp3,_temp254)
      else
        _error(exception:method_error(_temp247, "walk"))
      end

      elseif _temp247 == nil then
        _error(exception:null_error("_temp247", "invoke walk on it"))
      else
        ...
        if _t == "table" then
          if _rawget(_temp5, "__call_thing") == nil then
            _temp254 = _temp5
                  ...
                  if _temp5 == nil then
              if _type(_self._temp5) == "function" or (_type(_self._temp5) == "table" and _rawget(_self._temp5, "__call_thing")) then
        _temp254 =  _self:_temp5()
      elseif _self._temp5 ~= nil then
        _temp254 =  _self._temp5

        elseif _self.no_undermethod ~= nil then
          _temp254 =  _self:no_undermethod(string:new("_temp5"))
        else
          _error(exception:null_error("a", "invoke method"))
        end
      else 
        _temp254 =  _temp5(_self)
      end
...
local _temp262 = function (_self, _temp255)
...
local _temp258 = nil
    if _type(_true) == "function" or (_type(_true) == "table" and _rawget(_true, "__call_thing")) then
      _temp258 =  _true(_self)

    elseif _true then
      _temp258 =  _true
    else
            if _type(_self._true) == "function" or (_type(_self._true) == "table" and _rawget(_self._true, "__call_thing")) then
        _temp258 =  _self:_true()
      elseif _self._true ~= nil then
        _temp258 =  _self._true
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        _temp258 =  _self:no_undermethod(string:new("_true"))
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        _temp258 =  no_undermethod(_self, string:new("_true"))
      else
        _error(exception:name_error("_true"))
      end
    end
...
local _temp259 = nil
        ...
        _temp259 =  _self:_temp255()
      elseif _self._temp255 ~= nil then
        _temp259 =  _self._temp255

        elseif _self.no_undermethod ~= nil then
          _temp259 =  _self:no_undermethod(string:new("_temp255"))
        else
          _error(exception:null_error("node", "invoke method"))
        end
      else 
      ...
      if _t == "table" then
                      if _type(_temp259.id) == "function" or (_type(_temp259.id) == "table" and _rawget(_temp259.id, "__call_thing")) then
        _temp259 = _temp259:id()
      elseif _temp259.id ~= nil then
        _temp259 = _temp259.id

        elseif _temp259.no_undermethod ~= nil then
          _temp259 =  _temp259:no_undermethod(string:new("id"))
        else
          _error(exception:method_error(_temp259, "id"))
        end
      ...
      if _n.id ~= nil then
        _temp259 = _n:id()
      elseif _n.no_undermethod ~= nil then
        _temp259 =  _n:no_undermethod(string:new("id"))
      else
        _error(exception:method_error(_temp259, "id"))
      end
      ...
      if _f.id ~= nil then
        _temp259 = _f:id()
      elseif _f.no_undermethod ~= nil then
        _temp259 =  _f:no_undermethod(string:new("id"))
      else
        _error(exception:method_error(_temp259, "id"))
      end

      elseif _temp259 == nil then
        _error(exception:null_error("_temp259", "invoke id on it"))
      else
        _error("Tried to invoke method on something strange: " .. _tostring(_temp259))
      end


_temp257:set(_temp259, _temp258)
end
...
local _temp260 = nil
        ...
        if _t == "table" then
          if _rawget(_temp255, "__call_thing") == nil then
            _temp260 = _temp255
                  ...
                  if _temp255 == nil then
              if _type(_self._temp255) == "function" or (_type(_self._temp255) == "table" and _rawget(_self._temp255, "__call_thing")) then
        _temp260 =  _self:_temp255()
      elseif _self._temp255 ~= nil then
        _temp260 =  _self._temp255

        elseif _self.no_undermethod ~= nil then
          _temp260 =  _self:no_undermethod(string:new("_temp255"))
        else
          _error(exception:null_error("node", "invoke method"))
        end
      else 
        _temp260 =  _temp255(_self)
      end
    ...
    if _type(process) == "function" or (_type(process) == "table" and _rawget(process, "__call_thing")) then
      return  process(_self, _temp260)

    elseif process then
      _error(exception:new("Tried to invoke non-method: process (" .. object.__type(process) .. ")"))
    else
            if _type(_self.process) == "function" or (_type(_self.process) == "table" and _rawget(_self.process, "__call_thing")) then
        return  _self:process(_temp260)
      elseif _self.process ~= nil then
        return  _self.process
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        return  _self:no_undermethod(string:new("process") , _temp260)
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        return  no_undermethod(_self, string:new("process") , _temp260)
      else
        _error(exception:name_error("process"))
      end
    end
      ...
      if _t == "table" then
                      if _type(_temp254.walk) == "function" or (_type(_temp254.walk) == "table" and _rawget(_temp254.walk, "__call_thing")) then
        _dummy_ = _temp254:walk(_temp3,_temp262)
      elseif _temp254.walk ~= nil then
        _dummy_ = _temp254.walk

        elseif _temp254.no_undermethod ~= nil then
          _dummy_ =  _temp254:no_undermethod(string:new("walk") , _temp3,_temp262)
        else
          _error(exception:method_error(_temp254, "walk"))
        end

      elseif _t == "number" then
              local _n = number:new(_temp254)
      if _n.walk ~= nil then
        _dummy_ = _n:walk(_temp3,_temp262)
      elseif _n.no_undermethod ~= nil then
        _dummy_ =  _n:no_undermethod(string:new("walk") , _temp3,_temp262)
      else
        _error(exception:method_error(_temp254, "walk"))
      end
      ...
      if _f.walk ~= nil then
        _dummy_ = _f:walk(_temp3,_temp262)
      elseif _f.no_undermethod ~= nil then
        _dummy_ =  _f:no_undermethod(string:new("walk") , _temp3,_temp262)
      else
        _error(exception:method_error(_temp254, "walk"))
      end

      elseif _temp254 == nil then
        _error(exception:null_error("_temp254", "invoke walk on it"))
      else
        ...
        if _t == "table" then
          if _rawget(_temp5, "__call_thing") == nil then
            _temp262 = _temp5
                  ...
                  if _temp5 == nil then
              if _type(_self._temp5) == "function" or (_type(_self._temp5) == "table" and _rawget(_self._temp5, "__call_thing")) then
        _temp262 =  _self:_temp5()
      elseif _self._temp5 ~= nil then
        _temp262 =  _self._temp5

        elseif _self.no_undermethod ~= nil then
          _temp262 =  _self:no_undermethod(string:new("_temp5"))
        else
          _error(exception:null_error("a", "invoke method"))
        end
      else 
        _temp262 =  _temp5(_self)
      end
...
local _temp269 = function (_self, _temp263)
        if _temp263 == nil then
          _error(exception:argument_error("function", 1, 0))
...
do
      ...
      if _t == "table" then
                      if _type(_temp265.env) == "function" or (_type(_temp265.env) == "table" and _rawget(_temp265.env, "__call_thing")) then
        _temp265 = _temp265:env()
      elseif _temp265.env ~= nil then
        _temp265 = _temp265.env

        elseif _temp265.no_undermethod ~= nil then
          _temp265 =  _temp265:no_undermethod(string:new("env"))
        else
          _error(exception:method_error(_temp265, "env"))
        end
      ...
      if _n.env ~= nil then
        _temp265 = _n:env()
      elseif _n.no_undermethod ~= nil then
        _temp265 =  _n:no_undermethod(string:new("env"))
      else
        _error(exception:method_error(_temp265, "env"))
      end
      ...
      if _f.env ~= nil then
        _temp265 = _f:env()
      elseif _f.no_undermethod ~= nil then
        _temp265 =  _f:no_undermethod(string:new("env"))
      else
        _error(exception:method_error(_temp265, "env"))
      end

      elseif _temp265 == nil then
        _error(exception:null_error("_temp265", "invoke env on it"))
      else
...
local _temp266 = nil
    if _type(_true) == "function" or (_type(_true) == "table" and _rawget(_true, "__call_thing")) then
      _temp266 =  _true(_self)

    elseif _true then
      _temp266 =  _true
    else
            if _type(_self._true) == "function" or (_type(_self._true) == "table" and _rawget(_self._true, "__call_thing")) then
        _temp266 =  _self:_true()
      elseif _self._true ~= nil then
        _temp266 =  _self._true
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        _temp266 =  _self:no_undermethod(string:new("_true"))
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        _temp266 =  no_undermethod(_self, string:new("_true"))
      else
        _error(exception:name_error("_true"))
      end
    end
...
local _temp267 = nil
        ...
        if _t == "table" then
          if _rawget(_temp263, "__call_thing") == nil then
            _temp267 = _temp263
          else
                  if _temp263 == nil then
              if _type(_self._temp263) == "function" or (_type(_self._temp263) == "table" and _rawget(_self._temp263, "__call_thing")) then
        _temp267 =  _self:_temp263()
      elseif _self._temp263 ~= nil then
        _temp267 =  _self._temp263

        elseif _self.no_undermethod ~= nil then
          _temp267 =  _self:no_undermethod(string:new("_temp263"))
        else
          _error(exception:null_error("node", "invoke method"))
        end
      else 
      ...
      if _t == "table" then
                      if _type(_temp267.id) == "function" or (_type(_temp267.id) == "table" and _rawget(_temp267.id, "__call_thing")) then
        _temp267 = _temp267:id()
      elseif _temp267.id ~= nil then
        _temp267 = _temp267.id

        elseif _temp267.no_undermethod ~= nil then
          _temp267 =  _temp267:no_undermethod(string:new("id"))
        else
          _error(exception:method_error(_temp267, "id"))
        end
      ...
      if _n.id ~= nil then
        _temp267 = _n:id()
      elseif _n.no_undermethod ~= nil then
        _temp267 =  _n:no_undermethod(string:new("id"))
      else
        _error(exception:method_error(_temp267, "id"))
      end
      ...
      if _f.id ~= nil then
        _temp267 = _f:id()
      elseif _f.no_undermethod ~= nil then
        _temp267 =  _f:no_undermethod(string:new("id"))
      else
        _error(exception:method_error(_temp267, "id"))
      end

      elseif _temp267 == nil then
        _error(exception:null_error("_temp267", "invoke id on it"))
      else
        _error("Tried to invoke method on something strange: " .. _tostring(_temp267))
      end


_temp265 = _temp265:set(_temp267, _temp266)
end
...
return _temp265
      ...
      if _t == "table" then
                      if _type(_temp262.walk) == "function" or (_type(_temp262.walk) == "table" and _rawget(_temp262.walk, "__call_thing")) then
        _dummy_ = _temp262:walk(_temp3,_temp269)
      elseif _temp262.walk ~= nil then
        _dummy_ = _temp262.walk

        elseif _temp262.no_undermethod ~= nil then
          _dummy_ =  _temp262:no_undermethod(string:new("walk") , _temp3,_temp269)
        else
      ...
      if _n.walk ~= nil then
        _dummy_ = _n:walk(_temp3,_temp269)
      elseif _n.no_undermethod ~= nil then
        _dummy_ =  _n:no_undermethod(string:new("walk") , _temp3,_temp269)
      else
        _error(exception:method_error(_temp262, "walk"))
      end
      ...
      if _f.walk ~= nil then
        _dummy_ = _f:walk(_temp3,_temp269)
      elseif _f.no_undermethod ~= nil then
        _dummy_ =  _f:no_undermethod(string:new("walk") , _temp3,_temp269)
      else
        _error(exception:method_error(_temp262, "walk"))
      end

      elseif _temp262 == nil then
        _error(exception:null_error("_temp262", "invoke walk on it"))
      else
        ...
        if _t == "table" then
          if _rawget(_temp5, "__call_thing") == nil then
            _temp269 = _temp5
                  ...
                  if _temp5 == nil then
              if _type(_self._temp5) == "function" or (_type(_self._temp5) == "table" and _rawget(_self._temp5, "__call_thing")) then
        _temp269 =  _self:_temp5()
      elseif _self._temp5 ~= nil then
        _temp269 =  _self._temp5

        elseif _self.no_undermethod ~= nil then
          _temp269 =  _self:no_undermethod(string:new("_temp5"))
        else
          _error(exception:null_error("a", "invoke method"))
        end
      else 
        _temp269 =  _temp5(_self)
      end
...
local _temp299 = function (_self, _temp270)
...
local _temp271 = nil
        ...
        _temp271 =  _self:_temp270()
      elseif _self._temp270 ~= nil then
        _temp271 =  _self._temp270

        elseif _self.no_undermethod ~= nil then
          _temp271 =  _self:no_undermethod(string:new("_temp270"))
        else
          _error(exception:null_error("node", "invoke method"))
        end
      else 
        _temp271 =  _temp270(_self)
      end
      ...
      if _t == "table" then
                      if _type(_temp271.target) == "function" or (_type(_temp271.target) == "table" and _rawget(_temp271.target, "__call_thing")) then
        _temp271 = _temp271:target()
      elseif _temp271.target ~= nil then
        _temp271 = _temp271.target

        elseif _temp271.no_undermethod ~= nil then
          _temp271 =  _temp271:no_undermethod(string:new("target"))
        else
      ...
      if _n.target ~= nil then
        _temp271 = _n:target()
      elseif _n.no_undermethod ~= nil then
        _temp271 =  _n:no_undermethod(string:new("target"))
      else
        _error(exception:method_error(_temp271, "target"))
      end
      ...
      if _f.target ~= nil then
        _temp271 = _f:target()
      elseif _f.no_undermethod ~= nil then
        _temp271 =  _f:no_undermethod(string:new("target"))
      else
        _error(exception:method_error(_temp271, "target"))
      end

      elseif _temp271 == nil then
        _error(exception:null_error("_temp271", "invoke target on it"))
      else
...
local _temp273 = nil
      ...
      if _t == "table" then
                      if _type(_temp273.method) == "function" or (_type(_temp273.method) == "table" and _rawget(_temp273.method, "__call_thing")) then
        _temp273 = _temp273:method()
      elseif _temp273.method ~= nil then
        _temp273 = _temp273.method

        elseif _temp273.no_undermethod ~= nil then
          _temp273 =  _temp273:no_undermethod(string:new("method"))
        else
          _error(exception:method_error(_temp273, "method"))
        end
      ...
      if _n.method ~= nil then
        _temp273 = _n:method()
      elseif _n.no_undermethod ~= nil then
        _temp273 =  _n:no_undermethod(string:new("method"))
      else
        _error(exception:method_error(_temp273, "method"))
      end
      ...
      if _f.method ~= nil then
        _temp273 = _f:method()
      elseif _f.no_undermethod ~= nil then
        _temp273 =  _f:no_undermethod(string:new("method"))
      else
        _error(exception:method_error(_temp273, "method"))
      end

      elseif _temp273 == nil then
        _error(exception:null_error("_temp273", "invoke method on it"))
      else
    ...
    if _type(var_undertype) == "function" or (_type(var_undertype) == "table" and _rawget(var_undertype, "__call_thing")) then
      _temp272 =  var_undertype(_self, _temp273)

    elseif var_undertype then
      _error(exception:new("Tried to invoke non-method: var_type (" .. object.__type(var_undertype) .. ")"))
    else
            if _type(_self.var_undertype) == "function" or (_type(_self.var_undertype) == "table" and _rawget(_self.var_undertype, "__call_thing")) then
        _temp272 =  _self:var_undertype(_temp273)
      elseif _self.var_undertype ~= nil then
        _temp272 =  _self.var_undertype

      elseif _type(_self) == "number" then
        --I don't believe this will happen
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        _temp272 =  _self:no_undermethod(string:new("var_type") , _temp273)
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        _temp272 =  no_undermethod(_self, string:new("var_type") , _temp273)
      else
        _error(exception:name_error("var_type"))
      end
    end
...
local _temp274 = nil
    ...
    elseif _temp272 then
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        _temp274 =  _self:no_undermethod(string:new("t"))
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        _temp274 =  no_undermethod(_self, string:new("t"))
      else
        _error(exception:name_error("t"))
      end
    end

local _temp275 = string:new("local")
local _temp276
      local _t = _type(_temp274)
      if _t == "table" then
                      if _type(_temp274._equal_equal) == "function" or (_type(_temp274._equal_equal) == "table" and _rawget(_temp274._equal_equal, "__call_thing")) then
        _temp276 = _temp274:_equal_equal(_temp275)
      elseif _temp274._equal_equal ~= nil then
        _temp276 = _temp274._equal_equal

        elseif _temp274.no_undermethod ~= nil then
          _temp276 =  _temp274:no_undermethod(string:new("==") , _temp275)
        else
          _error(exception:method_error(_temp274, "=="))
        end

      elseif _t == "number" then
              if number._unchanged('_equal_equal') and _type(_temp275) == 'number' then
              if _temp274 == _temp275 then
        _temp276 = object.__true
      else
        _temp276 = object.__false
      end

      else
              local _n = number:new(_temp274)
      if _n._equal_equal ~= nil then
        _temp276 = _n:_equal_equal(_temp275)
      elseif _n.no_undermethod ~= nil then
        _temp276 =  _n:no_undermethod(string:new("==") , _temp275)
      else
        _error(exception:method_error(_temp274, "=="))
      end
      ...
      if _f._equal_equal ~= nil then
        _temp276 = _f:_equal_equal(_temp275)
      elseif _f.no_undermethod ~= nil then
        _temp276 =  _f:no_undermethod(string:new("==") , _temp275)
      else
        _error(exception:method_error(_temp274, "=="))
      end
...
local _temp278 = string:new("meth_access_local")

        if _type(_temp277) == "table" then
          _temp277["name"] = _temp278
        elseif _type(_temp277) == "number" then
          number["name"] = _temp278
        else
...
local _temp281 = nil
    ...
    elseif _temp272 then
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        _temp281 =  _self:no_undermethod(string:new("t"))
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        _temp281 =  no_undermethod(_self, string:new("t"))
      else
        _error(exception:name_error("t"))
      end
    end

local _temp282 = string:new("up")
local _temp283
      local _t = _type(_temp281)
      if _t == "table" then
                      if _type(_temp281._equal_equal) == "function" or (_type(_temp281._equal_equal) == "table" and _rawget(_temp281._equal_equal, "__call_thing")) then
        _temp283 = _temp281:_equal_equal(_temp282)
      elseif _temp281._equal_equal ~= nil then
        _temp283 = _temp281._equal_equal
      ...
      elseif _t == "number" then
              if number._unchanged('_equal_equal') and _type(_temp282) == 'number' then
              if _temp281 == _temp282 then
        _temp283 = object.__true
      else
        _temp283 = object.__false
      end

      else
              local _n = number:new(_temp281)
      if _n._equal_equal ~= nil then
        _temp283 = _n:_equal_equal(_temp282)
      elseif _n.no_undermethod ~= nil then
      ...
      if _f._equal_equal ~= nil then
        _temp283 = _f:_equal_equal(_temp282)
      elseif _f.no_undermethod ~= nil then
        ...
        if _t == "table" then
          if _rawget(_temp270, "__call_thing") == nil then
            _temp284 = _temp270
                  ...
                  if _temp270 == nil then
              if _type(_self._temp270) == "function" or (_type(_self._temp270) == "table" and _rawget(_self._temp270, "__call_thing")) then
        _temp284 =  _self:_temp270()
      elseif _self._temp270 ~= nil then
        _temp284 =  _self._temp270

        elseif _self.no_undermethod ~= nil then
          _temp284 =  _self:no_undermethod(string:new("_temp270"))
        else
          _error(exception:null_error("node", "invoke method"))
        end
      else 
        _temp284 =  _temp270(_self)
      end
...
local _temp285 = string:new("meth_access_up")

        if _type(_temp284) == "table" then
          _temp284["name"] = _temp285
        elseif _type(_temp284) == "number" then
          number["name"] = _temp285
        else
    ...
    elseif _temp270 then
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        _temp284 =  _self:no_undermethod(string:new("node"))
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        _temp284 =  no_undermethod(_self, string:new("node"))
      else
        _error(exception:name_error("node"))
      end
    end
    ...
    if _type(set_underupvar_underaccess) == "function" or (_type(set_underupvar_underaccess) == "table" and _rawget(set_underupvar_underaccess, "__call_thing")) then
      return  set_underupvar_underaccess(_self, _temp284)

    elseif set_underupvar_underaccess then
      _error(exception:new("Tried to invoke non-method: set_upvar_access (" .. object.__type(set_underupvar_underaccess) .. ")"))
    else
            if _type(_self.set_underupvar_underaccess) == "function" or (_type(_self.set_underupvar_underaccess) == "table" and _rawget(_self.set_underupvar_underaccess, "__call_thing")) then
        return  _self:set_underupvar_underaccess(_temp284)
      elseif _self.set_underupvar_underaccess ~= nil then
        return  _self.set_underupvar_underaccess
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        return  _self:no_undermethod(string:new("set_upvar_access") , _temp284)
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        return  no_undermethod(_self, string:new("set_upvar_access") , _temp284)
      else
        _error(exception:name_error("set_upvar_access"))
      end
    end
        ...
        if _t == "table" then
          if _rawget(_temp270, "__call_thing") == nil then
            _temp288 = _temp270
                  ...
                  if _temp270 == nil then
              if _type(_self._temp270) == "function" or (_type(_self._temp270) == "table" and _rawget(_self._temp270, "__call_thing")) then
        _temp288 =  _self:_temp270()
      elseif _self._temp270 ~= nil then
        _temp288 =  _self._temp270

        elseif _self.no_undermethod ~= nil then
          _temp288 =  _self:no_undermethod(string:new("_temp270"))
        else
          _error(exception:null_error("node", "invoke method"))
        end
      else 
        _temp288 =  _temp270(_self)
      end
...
local _temp289 = string:new("meth_access_self")

        if _type(_temp288) == "table" then
          _temp288["name"] = _temp289
        elseif _type(_temp288) == "number" then
          number["name"] = _temp289
        else
          _error("Cannot set method on " .. _temp288)
        end
...
return _temp289
    ...
    if _type(true_question) == "function" or (_type(true_question) == "table" and _rawget(true_question, "__call_thing")) then
      return  true_question(_self, _temp280,_temp287,_temp290)

    elseif true_question then
      _error(exception:new("Tried to invoke non-method: true? (" .. object.__type(true_question) .. ")"))
    else
            if _type(_self.true_question) == "function" or (_type(_self.true_question) == "table" and _rawget(_self.true_question, "__call_thing")) then
        return  _self:true_question(_temp280,_temp287,_temp290)
      elseif _self.true_question ~= nil then
        return  _self.true_question
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        return  _self:no_undermethod(string:new("true?") , _temp280,_temp287,_temp290)
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        return  no_undermethod(_self, string:new("true?") , _temp280,_temp287,_temp290)
      else
        _error(exception:name_error("true?"))
      end
    end
    ...
    if _type(true_question) == "function" or (_type(true_question) == "table" and _rawget(true_question, "__call_thing")) then
      return  true_question(_self, _temp273,_temp279,_temp292)

    elseif true_question then
      _error(exception:new("Tried to invoke non-method: true? (" .. object.__type(true_question) .. ")"))
    else
            if _type(_self.true_question) == "function" or (_type(_self.true_question) == "table" and _rawget(_self.true_question, "__call_thing")) then
        return  _self:true_question(_temp273,_temp279,_temp292)
      elseif _self.true_question ~= nil then
        return  _self.true_question
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        return  _self:no_undermethod(string:new("true?") , _temp273,_temp279,_temp292)
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        return  no_undermethod(_self, string:new("true?") , _temp273,_temp279,_temp292)
      else
        _error(exception:name_error("true?"))
      end
    end
...
local _temp295 = nil
        ...
        if _t == "table" then
          if _rawget(_temp270, "__call_thing") == nil then
            _temp295 = _temp270
                  ...
                  if _temp270 == nil then
              if _type(_self._temp270) == "function" or (_type(_self._temp270) == "table" and _rawget(_self._temp270, "__call_thing")) then
        _temp295 =  _self:_temp270()
      elseif _self._temp270 ~= nil then
        _temp295 =  _self._temp270

        elseif _self.no_undermethod ~= nil then
          _temp295 =  _self:no_undermethod(string:new("_temp270"))
        else
          _error(exception:null_error("node", "invoke method"))
        end
      else 
        _temp295 =  _temp270(_self)
      end
      ...
      if _t == "table" then
                      if _type(_temp295.target) == "function" or (_type(_temp295.target) == "table" and _rawget(_temp295.target, "__call_thing")) then
        _temp295 = _temp295:target()
      elseif _temp295.target ~= nil then
        _temp295 = _temp295.target

        elseif _temp295.no_undermethod ~= nil then
          _temp295 =  _temp295:no_undermethod(string:new("target"))
        else
          _error(exception:method_error(_temp295, "target"))
        end
      ...
      if _n.target ~= nil then
        _temp295 = _n:target()
      elseif _n.no_undermethod ~= nil then
        _temp295 =  _n:no_undermethod(string:new("target"))
      else
        _error(exception:method_error(_temp295, "target"))
      end
      ...
      if _f.target ~= nil then
        _temp295 = _f:target()
      elseif _f.no_undermethod ~= nil then
        _temp295 =  _f:no_undermethod(string:new("target"))
      else
        _error(exception:method_error(_temp295, "target"))
      end

      elseif _temp295 == nil then
        _error(exception:null_error("_temp295", "invoke target on it"))
      else
    ...
    if _type(process) == "function" or (_type(process) == "table" and _rawget(process, "__call_thing")) then
      return  process(_self, _temp295)

    elseif process then
      _error(exception:new("Tried to invoke non-method: process (" .. object.__type(process) .. ")"))
    else
            if _type(_self.process) == "function" or (_type(_self.process) == "table" and _rawget(_self.process, "__call_thing")) then
        return  _self:process(_temp295)
      elseif _self.process ~= nil then
        return  _self.process
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        return  _self:no_undermethod(string:new("process") , _temp295)
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        return  no_undermethod(_self, string:new("process") , _temp295)
      else
        _error(exception:name_error("process"))
      end
    end
    ...
    if _type(null_question) == "function" or (_type(null_question) == "table" and _rawget(null_question, "__call_thing")) then
      return  null_question(_self, _temp271,_temp294,_temp297)

    elseif null_question then
      _error(exception:new("Tried to invoke non-method: null? (" .. object.__type(null_question) .. ")"))
    else
            if _type(_self.null_question) == "function" or (_type(_self.null_question) == "table" and _rawget(_self.null_question, "__call_thing")) then
        return  _self:null_question(_temp271,_temp294,_temp297)
      elseif _self.null_question ~= nil then
        return  _self.null_question
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        return  _self:no_undermethod(string:new("null?") , _temp271,_temp294,_temp297)
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        return  no_undermethod(_self, string:new("null?") , _temp271,_temp294,_temp297)
      else
        _error(exception:name_error("null?"))
      end
    end
      ...
      if _t == "table" then
                      if _type(_temp269.walk) == "function" or (_type(_temp269.walk) == "table" and _rawget(_temp269.walk, "__call_thing")) then
        _dummy_ = _temp269:walk(_temp3,_temp299)
      elseif _temp269.walk ~= nil then
        _dummy_ = _temp269.walk

        elseif _temp269.no_undermethod ~= nil then
          _dummy_ =  _temp269:no_undermethod(string:new("walk") , _temp3,_temp299)
        else
          _error(exception:method_error(_temp269, "walk"))
        end

      elseif _t == "number" then
              local _n = number:new(_temp269)
      if _n.walk ~= nil then
        _dummy_ = _n:walk(_temp3,_temp299)
      elseif _n.no_undermethod ~= nil then
        _dummy_ =  _n:no_undermethod(string:new("walk") , _temp3,_temp299)
      else
        _error(exception:method_error(_temp269, "walk"))
      end
      ...
      if _f.walk ~= nil then
        _dummy_ = _f:walk(_temp3,_temp299)
      elseif _f.no_undermethod ~= nil then
        _dummy_ =  _f:no_undermethod(string:new("walk") , _temp3,_temp299)
      else
        _error(exception:method_error(_temp269, "walk"))
      end

      elseif _temp269 == nil then
        _error(exception:null_error("_temp269", "invoke walk on it"))
      else
...
_temp3 = string:new("var_assigner")
    ...
    if _type(export) == "function" or (_type(export) == "table" and _rawget(export, "__call_thing")) then
      _dummy_ =  export(_self, _temp299,_temp3)
    ...
    elseif export then
      _error(exception:new("Tried to invoke non-method: export (" .. object.__type(export) .. ")"))
        ...
        _dummy_ =  _self:export(_temp299,_temp3)
      ...
      elseif _type(_self) == "number" then
        ...
        _error("WHAT. No.")
      elseif _self.no_undermethod ~= nil then
        _dummy_ =  _self:no_undermethod(string:new("export") , _temp299,_temp3)
      elseif _type(no_undermethod) == "function" or (_type(no_undermethod) == "table" and _rawget(no_undermethod, "__call_thing")) then
        _dummy_ =  no_undermethod(_self, string:new("export") , _temp299,_temp3)
      else
